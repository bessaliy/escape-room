        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/crypt/crypt-size-s.jpg" srcSet="/img/content/crypt/crypt-size-s@2x.jpg 2x"
                width="344" height="232" alt="Мужчина в клетке в подземелье."
              />
            </picture>
          </div>
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/maniac/maniac-size-s.jpg" srcSet="/img/content/maniac/maniac-size-s@2x.jpg 2x"
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/ritual/ritual-size-s.jpg" srcSet="/img/content/ritual/ritual-size-s@2x.jpg 2x"
                width="344" height="232" alt="Череп и горящая свеча в тёмном помещении."
              />
            </picture>
          </div>
          <div className="quest-card__content">
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/ghosts/ghosts-size-s.jpg" srcSet="/img/content/ghosts/ghosts-size-s@2x.jpg 2x"
                width="344" height="232" alt="Силует девушки за стеклом."
              />
            </picture>
          </div>
          <div className="quest-card__content">
            <div className="quest-card__info-wrapper">
              <a className="quest-card__link" href="quest.html">История
                призраков
              </a>
            </div>
            <ul className="tags quest-card__tags">
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/palace/palace-size-s.jpg" srcSet="/img/content/palace/palace-size-s@2x.jpg 2x"
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/hut/hut-size-s.jpg" srcSet="/img/content/hut/hut-size-s@2x.jpg 2x" width="344"
                height="232" alt="Череп животного в руках девушки."
              />
            </picture>
          </div>
          <div className="quest-card__content">
            <div className="quest-card__info-wrapper">
              <a className="quest-card__link" href="quest.html">Хижина
                в&nbsp;лесу
              </a>
            </div>
            <ul className="tags quest-card__tags">
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/experiment/experiment-size-s.jpg"
                srcSet="/img/content/experiment/experiment-size-s@2x.jpg 2x" width="344" height="232"
          ...
          <div className="quest-card__content">
            <div className="quest-card__info-wrapper">
              <a className="quest-card__link" href="quest.html">Фатальный
                эксперимент
              </a>
            </div>
            <ul className="tags quest-card__tags">
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/metro/metro-size-s.jpg" srcSet="/img/content/metro/metro-size-s@2x.jpg 2x"
                width="344" height="232" alt="Мужчина на фоне кирпичной стены."
              />
            </picture>
          </div>
          <div className="quest-card__content">
            <div className="quest-card__info-wrapper">
              <a className="quest-card__link" href="quest.html">Метро 2033
              </a>
            </div>
            <ul className="tags quest-card__tags">
              <li className="tags__item">
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/loft/loft-size-s.jpg" srcSet="/img/content/loft/loft-size-s@2x.jpg 2x" width="344"
                height="232" alt="Фотоапарат, очки и канцелярские предметы на фоне карты."
              />
            </picture>
          </div>
          <div className="quest-card__content">
            <div className="quest-card__info-wrapper">
              <a className="quest-card__link" href="quest.html">Старый
                чердак
              </a>
            </div>
            <ul className="tags quest-card__tags">
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/frontier/frontier-size-s.jpg"
                srcSet="/img/content/frontier/frontier-size-s@2x.jpg 2x" width="344" height="232"
          ...
          <div className="quest-card__content">
            <div className="quest-card__info-wrapper">
              <a className="quest-card__link" href="quest.html">Последний
                рубеж
              </a>
            </div>
            <ul className="tags quest-card__tags">
        ...
        <div className="quest-card">
          <div className="quest-card__img">
            <picture>
              ...
              />
              <img src="/img/content/mars/mars-size-s.jpg" srcSet="/img/content/mars/mars-size-s@2x.jpg 2x" width="344"
                height="232" alt="Сюрреалистичное изображение человека."
              />
            </picture>
          </div>
          <div className="quest-card__content">
